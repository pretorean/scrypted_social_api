  ...
  Future upgrade() async {
    ...
    database.createTable(SchemaTable("users", [
      ...
      SchemaColumn("lastName", ManagedPropertyType.string,
          ...
          isNullable: false,
          isUnique: false),
      SchemaColumn("midName", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          isIndexed: true,
          isNullable: true,
          isUnique: false),
      SchemaColumn("phone", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          isIndexed: true,
          isNullable: true,
      ...
      SchemaColumn("email", ManagedPropertyType.string,
          ...
          isNullable: true,
          isUnique: false),
      SchemaColumn("subscribeNews", ManagedPropertyType.boolean,
          isPrimaryKey: false,
          autoincrement: false,
          defaultValue: "false",
          isIndexed: true,
          isNullable: false,
          isUnique: false),
      SchemaColumn("systemRole", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          defaultValue: "'user'",
          isIndexed: true,
          isNullable: false,
          isUnique: false),
      SchemaColumn("state", ManagedPropertyType.string,
          isPrimaryKey: false,
          autoincrement: false,
          defaultValue: "'active'",
          isIndexed: true,

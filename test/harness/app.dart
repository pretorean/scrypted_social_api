...
export 'package:scrypted_social_api/scrypted_social_api.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for scrypted_social_api.
///
...
///         }
///
class Harness extends TestHarness<ScryptedSocialApiChannel> with TestHarnessAuthMixin<ScryptedSocialApiChannel>, TestHarnessORMMixin {
  @override
